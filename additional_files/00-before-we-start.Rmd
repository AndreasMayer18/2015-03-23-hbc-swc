...
Use `#` signs to comment. Comment liberally in your R scripts. This will help future you and other collabrators of what each line of code (or code block) was meant to do. Anything to the right of a `#` is ignored by R. A shortcut for this is `Ctrl + Shift + C` if you wanted to comment an entire chunk of text.
