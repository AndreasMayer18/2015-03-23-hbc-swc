...
* Under the `File` menu, click on `New project`, choose `Version Control`, then
  `Git`
* Here you will be prompted to enter a `Repository URL`. The directory structure is located in GitHub and so you will need the following url to clone the repo: https://github.com/mistrm82/2015-03-23-hbc-swc.git. 
